...
> <!-- Multiline -->
> We and split up databases with SQL too (sharding), though it's easier with NoSQL and sharding is possible by default. The following is a replication example:
> 
